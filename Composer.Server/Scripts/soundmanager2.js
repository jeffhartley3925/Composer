...
(function (window) {
    ...
    */
    ...
    function SoundManager(smURL, smID) {
        ...
        this.html5PollingInterval = 5;  // msec affecting whileplaying() for HTML5 audio, excluding mobile devices. If null, native HTML5 update events are used.
        this.flashLoadTimeout = 1000;      // msec to wait for flash movie to load before failing (0 = infinity)
        this.wmode = 'transparent';                 // flash rendering mode - null, 'transparent', or 'opaque' (last two allow z-index to work)
