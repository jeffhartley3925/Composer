...
namespace Composer.Modules.Composition.Views
{
    ...
    public static class WriteableBitmapExtensions
    {
        ...
        //ADDED By Jeff Hartley from the following sources
        ...
        public static Stream GetStream(this WriteableBitmap bitmap)
        {
            ...
            for (var y = 0; y < bitmap.PixelHeight; ++y)
            {
                ...
                {
                    var pixel = bitmap.Pixels[bitmap.PixelWidth * y + x];
